...
import { CirclesModelCanvas } from '../components/CirclesModelCanvas'
...
export const Landing: React.FC<LandingProps> = ({ showSplash = false }) => {
  ...
  return (
    <>
      ...
      {/* FillUp Platform Features - Three.js Canvas with Scroll Animation (Full-screen hero) */}
      <section
        data-header-theme="light"
        className="relative z-20 overflow-hidden h-screen w-full"
        style={{
          background: 'linear-gradient(135deg, #0b1330 0%, #0f2345 50%, #0b1630 100%)'
        }}
      >
        <div className="absolute inset-0 w-full h-full">
          {/* Header removed — using clean full-bleed canvas */}

          {/* Orbit/Canvas Container with Scroll-Linked Animation (full viewport) */}
          <div className="absolute inset-0 flex items-center justify-center">
            {/* 3D Model */}
            <div className="relative w-full h-full flex items-center justify-center">
              <div className="relative w-full h-full overflow-hidden">
                <CirclesModelCanvas className="w-full h-full pointer-events-none" />
              </div>
            </div>

            {/* Positioned Callouts (absolute, overlay the canvas area) */}
            <div className="absolute inset-0 pointer-events-none">
              {/* 1: Top-Right */}
              <div 
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-white text-black font-bold text-lg shadow-lg">
                    1
                  </div>
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white uppercase tracking-tight leading-tight">
                      Faster time<br />to service
                    </h3>
                    <Link 
                      to="/request/fuel"
                      className="mt-4 inline-flex items-center gap-2 uppercase font-semibold text-sm text-white/90 hover:text-white transition-colors"
                    >
                      Read more
                      <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-white/40">
                        <svg viewBox="0 0 16 16" className="h-3 w-3" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white uppercase tracking-tight leading-tight">
                      Minimal effort<br />from your side
                    </h3>
                    <Link 
                      to="/request/mechanic"
                      className="mt-4 inline-flex items-center gap-2 uppercase font-semibold text-sm text-black hover:text-gray-700 transition-colors"
                    >
                      Read more
                      <span className="inline-flex h-5 w-5 items-center justify-center rounded-full border border-white/40">
                        <svg viewBox="0 0 16 16" className="h-3 w-3" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white uppercase tracking-tight leading-tight">
                      Lower overall<br />cost per trip
                    </h3>
                    <Link 
                      to="/dashboard"
                      className="mt-4 inline-flex items-center gap-2 uppercase font-semibold text-sm text-black hover:text-gray-700 transition-colors"
