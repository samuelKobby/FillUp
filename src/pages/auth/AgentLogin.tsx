...
export const AgentLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-600 to-purple-600 flex flex-col lg:flex-row lg:overflow-hidden">
      {/* Mobile Hero Section */}
      ...
      <div className="flex-1 bg-white rounded-t-3xl -mt-6 relative z-10 lg:rounded-none lg:mt-0 lg:w-1/2 lg:flex lg:items-center lg:justify-center lg:p-8">
        <div className="px-6 pt-8 pb-6 lg:w-full lg:max-w-md lg:px-0">
          ...
          <div className="hidden lg:block mb-8">
            <h2 className="text-4xl font-bold text-gray-900 mb-2">Welcome Agent!</h2>
            <p className="text-gray-600">Sign in to access your agent dashboard</p>
          </div>
          {/* Error Message */}
          {error && (
            ...
            <div>
              ...
              <div className="relative lg:block">
                ...
                <input
                  ...
                  className="block w-full pl-10 lg:pl-4 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 lg:pl-4 pr-10 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
          ...
          <div className="mt-6 text-center">
            ...
            <Link to="/agent/register" className="text-orange-600 hover:text-orange-500 font-semibold transition-colors">
              Become an Agent
            </Link>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 lg:border-0 lg:mt-6 lg:pt-0">
            ...
            <div className="grid grid-cols-2 gap-3 lg:block lg:text-center">
              ...
              <div className="hidden lg:block">
                ...
                <Link to="/login" className="text-orange-600 hover:text-orange-500 text-sm transition-colors mx-2">
                  Customer
                </Link>
                <span className="text-gray-400">•</span>
                <Link to="/station/login" className="text-orange-600 hover:text-orange-500 text-sm transition-colors mx-2">
                  Station
                </Link>
              </div>
            </div>
